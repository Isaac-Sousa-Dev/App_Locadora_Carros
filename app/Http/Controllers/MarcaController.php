...
class MarcaController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        */
        ...
        if($marca === null) {
            return response()->json(['erro' => 'Impossivel realizae a atualização, o recurso solicitado não existe!'], 404) ;
        }
        ...
        //preenchendo o $marca com todos os dados do request
        $marca->fill($request->all());

        //se a imagem foi encamnhada na requisição
